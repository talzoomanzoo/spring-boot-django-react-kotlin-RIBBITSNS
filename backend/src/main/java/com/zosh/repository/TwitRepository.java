...
public interface TwitRepository extends JpaRepository<Twit, Long> {
	...
	@Query(value = "select distinct * from twit t join list_model_followings lmf on t.user_id = lmf.followings_id where list_model_id=:#{#listId} and is_twit=1", nativeQuery = true)
