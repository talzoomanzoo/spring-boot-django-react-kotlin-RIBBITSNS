...
public class AuthController {
	...
	private static final String GOOGLE_CLIENT_ID = "770219797693-s1d7pmoo4as6o8gp2ldu75mn5g3oum1t.apps.googleusercontent.com";
...
//	        System.out.println("email ---- "+ existingUser.getEmail()+" jwt - "+token);
    ...
    public ResponseEntity<AuthResponse> signin(@RequestBody LoginRequest loginRequest) {
		...
		System.out.println("email ---- "+ loginRequest.getEmail()+" jwt - "+token);
