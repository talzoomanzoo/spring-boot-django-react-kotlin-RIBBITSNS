...
public interface NotificationsService {
    Notification notificationTwit(Long twitId, User user) throws UserException, TwitException;
    Notification unnotificationTwit(Long twitId, User user) throws UserException, TwitException, NotificationException;
    List<Notification> getAllNotifications(Long twitId) throws TwitException;
}
